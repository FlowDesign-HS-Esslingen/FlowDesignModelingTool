...
{
    /// <summary>
    /// ViewModel für Delegation im Prototype-Diagramm.
    /// </summary>
    /// <seealso cref="FlowDesign.UI.ViewModels.ComponentViewModels.LineComponentViewModel" />
    public class DelegationComponentViewModel : LineComponentViewModel
    {
        /// <summary>
        ...
        public Guid FlowViewID
        {
            get
            {
                return ((DelegationComponent)Component).FlowViewID;
            }

            set
            {
                ((DelegationComponent)Component).FlowViewID = value;
            }
        }
        ...
        /// Konstruktor.
        /// </summary>
        /// <param name="component">Die Delegate Komponente die hinzugefügt werden soll.</param>
        /// <param name="parentViewModel">Das ViewModel der Hauptseite, darf nicht null sein.</param>
        public DelegationComponentViewModel(DelegationComponent component, MainPageViewModel parentViewModel) : base(component, parentViewModel)
        {
